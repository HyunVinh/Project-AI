...
def run():
    ...
    img1 = img1.resize((600,250),)
    st.image(img1,use_column_width=False)
    st.title("Movie Recommender System")
    st.markdown('''<h4 style='text-align: left; color: #ea98aa;'>* Data is based "IMDB 5000 Movie Dataset"</h4>''',
    ...
    if cat_op == category[0]:
        ...
        st.markdown('''<h4 style='text-align: left; color: #dea98aa;'>* Fetching a Movie Posters will take a time."</h4>''',
                    unsafe_allow_html=True)
        if dec == 'No':
